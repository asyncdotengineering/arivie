---
title: "ADR 0005 — Reference deployment: a governed analytics agent in production"
description: "How the first real production analytics agent (Lens & Luxe) works end to end — read-only model, dashboard-exact semantic alignment, the prompt-path route, and the Vercel serverless fixes."
---
