---
title: "ADR 0002 — Arivie vs Mastra ownership"
description: "Who owns what — the leaf/spine boundary, ownership table, and the 30-second 'Arivie or Mastra for X?' decision guide."
---
