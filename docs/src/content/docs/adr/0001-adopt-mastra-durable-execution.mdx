---
title: "ADR 0001 — Adopt Mastra durable execution"
description: "Spike decision + plan: keep dispatch as the webhook front-door, adopt Mastra evented agents + workflows for durable suspend/resume."
---
